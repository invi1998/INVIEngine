...
public:
	...
	virtual void SetVisible(bool visible, CCustomMeshComponent* axis_component);
...
protected:
	...
	virtual XMVECTOR GetAnyAxisDirection(XMVECTOR& WorldOriginPoint, XMVECTOR& WorldDirection, XMVECTOR& ActorLocation) = 0;
