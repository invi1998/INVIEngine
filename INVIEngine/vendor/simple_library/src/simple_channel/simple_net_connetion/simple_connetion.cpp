...
#include "simple_library/simple_channel/simple_core/simple_connetion.h"
#include "simple_library/simple_channel/simple_net_protocols.h"
#include "simple_library/simple_c_log/simple_c_log.h"
// #include "..\..\..\public\simple_channel\simple_core\simple_channel.h"

FSimpleConnetion::FSimpleConnetion()
	: ConnetionState(ESimpleConnetionState::FREE), ConnetionType(ESimpleConnetionType::CONNETION_LISTEN), DriveType(ESimpleDriveType::DRIVETYPE_LISTEN), bHeartBeat(false), HeartTime(0.0)
{
}
