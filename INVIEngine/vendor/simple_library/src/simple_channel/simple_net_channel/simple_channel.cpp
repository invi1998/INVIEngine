...
#include "simple_library/simple_channel/simple_core/simple_channel.h"
#include "simple_library/simple_channel/simple_core/simple_connetion.h"
#include "simple_library/simple_math/simple_math.h"

FSimpleChannel::FSimpleChannel()
	: Connetion(nullptr), ID(get_uint32_random(9999999))
{
}
