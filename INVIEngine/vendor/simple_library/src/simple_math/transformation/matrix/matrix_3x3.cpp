...
#include "simple_library/simple_math/transformation/rotator/rotator.h"
#include <math.h>
#include "simple_library/simple_math/math_utils.h"
...
fmatrix_3x3::fmatrix_3x3(const fmatrix_4x4 &in_matrix)
	: m11(in_matrix.m11), m12(in_matrix.m12), m13(in_matrix.m13), m21(in_matrix.m21), m22(in_matrix.m22), m23(in_matrix.m23), m31(in_matrix.m31), m32(in_matrix.m32), m33(in_matrix.m33)
{
}
...
fmatrix_3x3::fmatrix_3x3(
	...
	: m11(in_m11), m12(in_m12), m13(in_m13), m21(in_m21), m22(in_m22), m23(in_m23), m31(in_m31), m32(in_m32), m33(in_m33)
{
}
