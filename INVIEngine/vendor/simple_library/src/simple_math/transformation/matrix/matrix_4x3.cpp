...
fmatrix_4x3::fmatrix_4x3(const fmatrix_4x4 &in_matrix)
	: m11(in_matrix.m11), m12(in_matrix.m12), m13(in_matrix.m13), m21(in_matrix.m21), m22(in_matrix.m22), m23(in_matrix.m23), m31(in_matrix.m31), m32(in_matrix.m32), m33(in_matrix.m33), x(0.f), y(0.f), z(0.f)
{
}
...
fmatrix_4x3::fmatrix_4x3(
	...
	: m11(in_m11), m12(in_m12), m13(in_m13), m21(in_m21), m22(in_m22), m23(in_m23), m31(in_m31), m32(in_m32), m33(in_m33), x(in_x), y(in_y), z(in_z)
{
}
...
{
	return in_m.m11 * (in_m.m22 * in_m.m33 - in_m.m23 * in_m.m32) + in_m.m12 * (in_m.m23 * in_m.m31 - in_m.m21 * in_m.m33 + in_m.m13 * (in_m.m21 * in_m.m32 - in_m.m22 * in_m.m31));
}
