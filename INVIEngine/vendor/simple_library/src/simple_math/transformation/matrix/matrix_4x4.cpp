#include "simple_library/simple_math/transformation/matrix/matrix_4x4.h"
#include "simple_library/simple_math/transformation/matrix/matrix_3x3.h"
#include "simple_library/simple_math/transformation/matrix/matrix_4x3.h"
#include "simple_library/simple_math/transformation/vector/vector_3d.h"
#include "simple_library/simple_math/transformation/quaternion/quat.h"
#include <math.h>
...
fmatrix_4x4::fmatrix_4x4(const fmatrix_4x3 &in_matrix)
    : m11(in_matrix.m11), m12(in_matrix.m12), m13(in_matrix.m13), m14(0.f), m21(in_matrix.m21), m22(in_matrix.m22), m23(in_matrix.m23), m24(0.f), m31(in_matrix.m31), m32(in_matrix.m32), m33(in_matrix.m33), m34(0.f), m41(in_matrix.x), m42(in_matrix.y), m43(in_matrix.z), m44(1.f)
{
}

fmatrix_4x4::fmatrix_4x4(const fmatrix_3x3 &in_matrix)
    : m11(in_matrix.m11), m12(in_matrix.m12), m13(in_matrix.m13), m14(0.f), m21(in_matrix.m21), m22(in_matrix.m22), m23(in_matrix.m23), m24(0.f), m31(in_matrix.m31), m32(in_matrix.m32), m33(in_matrix.m33), m34(0.f), m41(0.f), m42(0.f), m43(0.f), m44(1.f)
{
}
...
fmatrix_4x4::fmatrix_4x4(
    ...
    : m11(in_m11), m12(in_m12), m13(in_m13), m14(in_m14), m21(in_m21), m22(in_m22), m23(in_m23), m24(in_m24), m31(in_m31), m32(in_m32), m33(in_m33), m34(in_m34), m41(in_m41), m42(in_m42), m43(in_m43), m44(in_m44)
{
}
