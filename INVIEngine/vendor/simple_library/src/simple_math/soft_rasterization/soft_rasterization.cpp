#include "simple_library/simple_math/soft_rasterization/soft_rasterization.h"
...
namespace soft_rasterization
{
	...
	ftransform_component::ftransform_component()
		: scale(1.f), forward_vector(0.f, 0.f, 1.f), right_vector(1.f, 0.f, 0.f), up_vector(0.f, 1.f, 0.f)
	{
	}
