...
public:
	...
	FORCEINLINE CD3DX12_CPU_DESCRIPTOR_HANDLE& GetCPURenderTargetView() { return RenderTargetViewCPU; }
...
protected:
	...
	CD3DX12_CPU_DESCRIPTOR_HANDLE RenderTargetViewCPU;			// 渲染目标视图的CPU句柄 RTV
};
